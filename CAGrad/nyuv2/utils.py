...
def multi_task_mgd_trainer(train_loader, test_loader, multi_task_model, device,
    ...
    def tracking(grads, y, lambd, it, beta=beta, delta=delta, sigma2=sigma2, sigma3=sigma3):
        ...
        y_ =  y -beta/(1+it)**sigma2*(y-grads.cpu().numpy())
        # print('y', y_.shape)
        ...
        return torch.from_numpy(g).float().to(grads.device), y_, lambd_
