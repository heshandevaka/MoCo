...
parser.add_argument('--beta', default=0.1, type=float, help='beta for SMGDC')
parser.add_argument('--delta', default=0.1, type=float, help='delta for SMGDC')
parser.add_argument('--sigma2', default=0.5, type=float, help='sigma2 for SMGDC')
parser.add_argument('--sigma3', default=0.5, type=float, help='sigma2 for SMGDC')
parser.add_argument('--smgdc_method', default="None", type=str, help='method for SMGDC')
parser.add_argument('--alpha', default=0.5, type=float, help='the alpha')
# parser.add_argument('--normalize', default=False, type=bool, help='normalize gradients in tracking')
